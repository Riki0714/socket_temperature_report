...
//------ pNode: the pointer of header pointer
//		 insertElem: The data content of the new node
int list_insert_tail(Node **pNode, elemType insertElem)
{
	Node *pIn=NULL;
	Node *pHead=NULL;
	Node *pTmp=NULL;
...
//------ pNode: the pointer of header pointer
//		 insertElem: The data content of the new node
int list_insert_tail(Node **pHead, elemType insertElem)
{
	Node *pIn=NULL;
	Node *pTmp=*pHead;
	Node *pHead_o=*pHead;  
...
//------ pHead: the hearder pointer
//		 x: What to look for
Node * list_findi_Node(Node *pHead, elemType x)
{
	if( NULL == pHead )
	{
		printf("The list is empty\n");
...
elemType * list_get(Node *pHead, int pos)
{
	int			  i=0;
	elemType	 *buf=NULL;
